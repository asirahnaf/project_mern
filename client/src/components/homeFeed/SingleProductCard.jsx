...
import { IoStarSharp, IoTrashOutline, IoCreateOutline } from "react-icons/io5";
import axios from "axios";
import { useSelector } from "react-redux";

const SingleProductCard = ({ product, onEdit }) => {
  ...
  return (
    <>
      {/* Product Card */}
      <section
        className="w-full h-max pb-3 bg-white shadow-sm shadow-gray-300 rounded-lg relative cursor-pointer group"
          ...
          {role === "farmer" && (
            <div className="absolute top-2 right-2 flex gap-2">
              <button
                ...
                className="p-1.5 bg-white/90 rounded-full text-teal-700 hover:bg-white hover:text-teal-900 shadow-sm transition-all opacity-0 group-hover:opacity-100"
                title="Edit Product"
              >
              ...
              <button
                ...
                className="p-1.5 bg-white/90 rounded-full text-rose-700 hover:bg-white hover:text-rose-900 shadow-sm transition-all opacity-0 group-hover:opacity-100"
              ...
              {role === "farmer" && (
                <>
                  <button
                    ...
                    className="px-4 py-1.5 footnote bg-teal-700 text-white text-sm rounded-lg cursor-pointer hover:bg-teal-800"
                  >
                    Edit
                  </button>
                  <button

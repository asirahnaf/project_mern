...
const BillingModal = ({ isOpen, onClose, cartId, cartItemId }) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Assuming response structure response.data.data is the order object or contains _id
      const orderId = response.data.data?._id || "temp-id";
      navigate(`/buyer/payment-simulation/${orderId}`);
    } catch (error) {
